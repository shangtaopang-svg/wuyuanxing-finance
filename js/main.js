...
function buildTabContent(d, label) {
  ...
  return "<div style=\"border:1px solid #b8860b;border-radius:8px;overflow:hidden;background:#fefcf5\">" +
    ...
    "<div style=\"padding:8px 10px 4px\">" +
      ...
      "<div style=\"overflow-x:auto;max-height:300px;overflow-y:auto;border:1px solid #e8e5e0;border-radius:6px\"><table class=\"data-table\" style=\"font-size:0.68rem;min-width:450px\"><thead><tr><th style=\"width:35px\">\u5e8f\u53f7</th><th>\u59d3\u540d</th><th>\u8eab\u4efd\u8bc1\u53f7\u7801</th><th style=\"width:80px\">\u91d1\u989d</th></tr></thead><tbody>"+wr+"</tbody></table>"+(notes.length?"<div style=\"padding:6px 8px;background:#fefcf5;border-top:1px solid #e8e5e0;font-size:0.6rem;color:#888;line-height:1.6\"><strong>\u5907\u6ce8\uff1a</strong>"+notes.join("<br>")+"</div>":"")+"</div>" +
    "</div>" +
