...
function buildTabContent(d, label) {
  ...
  var lr = l.length ? l.map(function(r){ var n=r.notes||""; if(n.indexOf("\u53d1\u653e")>=0||n.indexOf("\u652f\u4ed8")>=0){n="<span style=\"display:inline-block;padding:2px 8px;border-radius:4px;font-size:0.6rem;font-weight:600;background:#e8f5e9;color:#2e7d32\">"+n+"</span>";} return "<tr><td>"+(r.date||"")+"</td><td>"+(r.headcount||"")+"</td><td>"+(r.work_content||"")+"</td><td class=\"amount\">"+formatNum(r.amount)+"</td><td>"+n+"</td></tr>"; }).join("") : "<tr><td colspan=\"5\" style=\"text-align:center;color:#999;padding:20px\">\u6682\u65e0\u8bb0\u5f55</td></tr>";
